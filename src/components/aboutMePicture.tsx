import aboutMe1 from "../../src/images/about-me-1.png";
import aboutMe2 from "../../src/images/about-me-2.png";
...
export default function AboutMePicture(props: { id: number }) {
  ...
  return (
    <>
      {props.id === 0 ? (
        <div style={pictureStyles[0]} className="bg-shiftUp shadow rounded inline-block w-56 float-right bg-cover bg-top h-72 ml-6 my-4"></div>
      ) : (
